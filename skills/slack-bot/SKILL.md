...
Prefer using Python as it's more flexible and better supported:

```sh
python3 -c "
import urllib.request, os, json
token = os.environ['SLACK_BOT_XOXB_TOKEN']
...
import urllib.request, os, json
token = os.environ['SLACK_BOT_XOXB_TOKEN']
body = json.dumps({'channel': 'C0123456789', 'text': 'hello'}).encode()
